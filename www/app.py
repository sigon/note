#!/usr/bin/env python3
# -*- coding: utf-8 -*-
from handlers.users import auth_factory
...
def response_factory(app, handler):
    def response(request):
        ...
        # else:
        #     # 如果是其它格式，输出信息
        #     logging.info('unknow response format: %s' % r)
...
@asyncio.coroutine
def init(loop):
    yield from orm.create_pool(loop=loop, host='127.0.0.1', port=3306, user='root', password='', db='test')
